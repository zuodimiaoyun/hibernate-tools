...
public class GeneratorUtil {
    ...
    public static void main(String[] args) throws Exception {
        List<Class> classes = GeneratorUtil.getAllClassByInterface(Class.forName("com.threeti.dao.base.IGenericDao"));
    ...
    public static String upperFirst(String s){
        ...
        return s.replaceFirst(firstLatter, firstLatter.toUpperCase());
    }
